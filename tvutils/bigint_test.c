...
int main(int argc __attribute__((unused)), char *argv[])
{
    ...
    r2048 = tvu_bigint2048_from_hex("9 12345678 11223344 55667788 11112222 33334444 55556666 77778888");
    TVU_UNITTEST_CMP(r2048.v[0], 0x5555666677778888);
    TVU_UNITTEST_CMP(r2048.v[1], 0x1111222233334444);
    TVU_UNITTEST_CMP(r2048.v[2], 0x1122334455667788);
    TVU_UNITTEST_CMP(r2048.v[3], 0x0000000912345678);
    TVU_UNITTEST_CMP(r2048.v[4], 0x0);
    TVU_UNITTEST_CMP(r2048.v[5], 0x0);
    TVU_UNITTEST_CMP(r2048.v[6], 0x0);
    TVU_UNITTEST_CMP(r2048.v[7], 0x0);
    TVU_UNITTEST_CMP(r2048.v[8], 0x0);
    TVU_UNITTEST_CMP(r2048.v[9], 0x0);

    a1024 = tvu_bigint1024_from_hex(
    ...
    b2048 = tvu_bigint2048_wide(b1024);

    b1024r = tvu_bigint1024_from_hex(
        "1"
    ...
    b2048r = tvu_bigint2048_wide(b1024r);

    // Test accumilator add.
    r1024 = a1024;
    tvu_bigint1024_iadd(&r1024, b1024);

    e1024 = tvu_bigint1024_from_hex(
        "1"
    ...
    TVU_UNITTEST_MEMCMP(&r1024, &e1024, sizeof (r1024));
    
    // Test accumilator sub.
    r1024 = b1024;
    tvu_bigint1024_isub(&r1024, a1024);
    ...
    // Test accumilator sub.
    r1024 = a1024;
    tvu_bigint1024_irshift(&r1024, 4);
    ...
    r2048 = BIGINT2048_MIN;
    tvu_bigint2048_ifma_digit(&r2048, a1024, 0xfedcba9876543210, 0);

    e2048 = tvu_bigint2048_from_hex(
        "645D173D AB0CD681"
    ...
    TVU_UNITTEST_MEMCMP(&r2048, &e2048, sizeof (r2048));
    
    // Test fused multiply-add
    r2048 = BIGINT2048_MIN;
    tvu_bigint2048_ifma(&r2048, a1024, b1024);
    ...
    // Test modulus.
    r2048 = tvu_bigint2048_mod(c2048, b2048, b2048r);
    e2048 = tvu_bigint2048_from_hex(
